...
def sample(args):
    ...
    with open('./storygeneration/save/config.pkl', 'rb') as f:
        saved_args = cPickle.load(f)
    # with open(os.path.join(args.save_dir, 'words_vocab.pkl'), 'rb') as f:
        # words, vocab = cPickle.load(f)
    with open('./storygeneration/save/words_vocab.pkl', 'rb') as f:
        words, vocab = cPickle.load(f)
    ...
    with tf.Session() as sess:
        ...
        ckpt = tf.train.get_checkpoint_state('./storygeneration/save/')
